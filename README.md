...
## 🌱 리턴미 컵 소개
"리턴미 컵"은 일회용 컵 사용을 줄이기 위한 다회용 컵 공유 서비스입니다. 사용자는 가맹 카페에서 보증금 없이 다회용 컵을 대여하고, 어느 가맹점에서나 반납할 수 있습니다. 이를 통해 일회용품 사용을 줄이고 자원 순환 경제를 실현하며, 환경 보호에 기여합니다. 하지만 기존에는 모바일 앱 설치가 필수였고, 매장 내에서 즉시 이용하기 어려운 문제가 있었습니다.
